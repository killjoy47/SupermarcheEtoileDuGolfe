...
import { ventes, lignesVente, articles, utilisateurs } from "./backend/dist/db/schema.js";
...
for (const r of rows) {
  ...
  console.log(JSON.stringify({ raw: v, typeof: typeof v, ctor: v?.constructor?.name, toString: String(v) }));
}
